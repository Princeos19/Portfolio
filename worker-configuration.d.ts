/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: adaa6a0c7edfeaab94838e4f3e788c83)
// Runtime types generated with workerd@1.20260415.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		R2_ASSETS: R2Bucket;
		DB: D1Database;
		VITE_STATIKFORM_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_STATIKFORM_ID" | "VITE_CONTACT_EMAIL">> {}
}
